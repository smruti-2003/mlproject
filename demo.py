...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            numerical_columns = [
                ...
                'uvindex', 'severerisk', 'sunriseEpoch', 'sunsetEpoch', 'moonphase'
            ]
            categorical_columns = ['conditions', 'description', 'icon', 'source', 'City', 'Month', 'Season', 'Day_of_Week']
            ...
            # Categorical pipeline with mode imputation and LabelEncoder
            cat_pipeline = Pipeline(steps=[
                ("imputer", SimpleImputer(strategy="most_frequent")),
                ("label_encoder", LabelEncoder()),  # Label encoding for categorical variables
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # Dropping target column from input features
