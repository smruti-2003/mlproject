...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            numerical_columns = [
                ...
                'solarenergy', 'uvindex', 'severerisk', 'sunriseEpoch', 
                'sunsetEpoch','moonphase', 'Temp_Range', 'Heat_Index', 
                'Severity_Score', 'Condition_Code', 'Month'
            ]    

            categorical_columns = [
                'datetime', 'preciptype', 'sunrise', 'sunset', 
                'conditions', 'description', 'icon',  
                'source', 'City', 'Season', 'Day_of_Week'
                ]
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Dropping 'stations' column and formatting 'datetimeEpoch'")
